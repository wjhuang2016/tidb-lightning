...
type AbstractBackend interface {
	...
	NewEncoder(tbl table.Table, options *SessionOptions, update bool, delete bool) Encoder
...
func (be Backend) NewEncoder(tbl table.Table, options *SessionOptions, update bool, delete bool) Encoder {
	return be.abstract.NewEncoder(tbl, options, update, delete)
}
